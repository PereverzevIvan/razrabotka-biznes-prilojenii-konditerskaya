...
func (service *JWTService) AccessTokenExpiration() time.Duration {
	return service.jwtService.AccessTokenExpiration()
}

func (service *JWTService) RefreshTokenExpiration() time.Duration {
	return service.jwtService.RefreshTokenExpiration()
}

func (service *JWTService) GenerateAccessAndRefreshTokens(user *models.User) (string, string, error) {
	return service.jwtService.GenerateAccessAndRefreshTokens(user)
}
