...
func (service *orderService) UpdateStatus(params *params_order.UpdateStatusParams) (order *models.Order, err error) {
...
func (service *orderService) updateToCanceled(params *params_order.UpdateStatusParams) (order *models.Order, err error) {
	var (
	...
	var data *params_order.UpdateStatusToCanceledData
...
func (service *orderService) updateToCompilingRecipe(params *params_order.UpdateStatusParams) (order *models.Order, err error) {
...
func (service *orderService) updateToConfirmation(params *params_order.UpdateStatusParams) (order *models.Order, err error) {
	if params.UserRole != models.KRoleClientManager.Name() {
	...
	var data params_order.UpdateStatusToConfirmationData
	err = services_utils.JsonUnmarshalInterface(params.Data, &data)
	if err != nil {
		return nil, fmt.Errorf("%w: %w", logic_errors.ErrInvalidUpdate, err)
	}
...
func (service *orderService) updateToPurchase(params *params_order.UpdateStatusParams) (order *models.Order, err error) {
...
func (service *orderService) updateToProduction(params *params_order.UpdateStatusParams) (order *models.Order, err error) {
...
func (service *orderService) updateToControl(params *params_order.UpdateStatusParams) (order *models.Order, err error) {
...
func (service *orderService) updateToReady(params *params_order.UpdateStatusParams) (order *models.Order, err error) {
	if params.UserRole != models.KRoleMaster.Name() {
		return nil, fmt.Errorf("%w: only master can update status to ready", logic_errors.ErrInvalidUpdate)
	}

	is_order_valid, err := service.qualityControlRepoo.IsOrderValid(params.OrderID)
	if err != nil {
		return nil, err
	}
...
func (service *orderService) updateToCompleted(params *params_order.UpdateStatusParams) (order *models.Order, err error) {
	if params.UserRole != models.KRoleClientManager.Name() {
