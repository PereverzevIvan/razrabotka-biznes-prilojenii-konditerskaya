...
func (service *orderService) Create(params *params_order.CreateParams) (order *models.Order, err error) {
...
func (service *orderService) generateOrderNumber(customer_id int, time_now time.Time) (string, error) {
